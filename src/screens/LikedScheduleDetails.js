...
const LikedScheduleDetails = ({navigation, route }) => {
  ...
  return (
    <View style={styles.viewWrapper} >
      <View style={{flexDirection:"row", alignItems:"center"}}>
          ...
          <Text style={[styles.title,{ marginLeft:"15%",fontSize:20}]}>{t("common:LikedScheduleDetails")}</Text>
      </View>
      <View>
...
export default LikedScheduleDetails
